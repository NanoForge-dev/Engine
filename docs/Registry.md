...
The registry class is written in C++ and exposed to WebAssembly using Emscripten.
This choice was made to leverage the performance benefits of C++ for managing entities and components in an ECS architecture.
